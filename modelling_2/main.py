...
ke = get_total_var(body_count, arguments.energies[0])
gpe = get_total_var(body_count, arguments.energies[1])
e_t = get_total_var(body_count, arguments.energies[2])
...
ams = get_total_var(body_count, arguments.ams)
